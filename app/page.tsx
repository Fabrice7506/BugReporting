...
useEffect(() => {
  ...
  return (
    <WrapperMain>
    <button className="btn btn-primary btn-sm btn-soft" onClick={()=>(document.getElementById('project') as HTMLDialogElement).showModal()}> <Plus className="w-4 h-4" /> Nouveau projet </button>
...
<dialog id="project" className="modal">
  <div className="modal-box">
    ...
    <h3 className="font-bold text-lg mb-2">Commencer par créer votre projet!</h3>
    ...
    <div className="flex flex-col gap-3">
      ...
      > { !isSubmitting ? "Créer le projet": <Loader className="animate-spin w-6 h-6 text-primary" />}</button>
    </div>
  </div>
</dialog>
